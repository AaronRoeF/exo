...
## [2026-09-25] — v0.1.4 — The agent-job schema names the evidence gate: a governed job's output is accepted only after its TRACE record and signed companion report verify.
- Source commit: d471330
